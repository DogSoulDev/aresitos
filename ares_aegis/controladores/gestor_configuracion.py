...
class GestorConfiguracion:
    ...
    def _guardar_configuracion_por_defecto(self) -> None:
        ...
        try:
            ruta_archivo = Path(self.directorio_config) / "ares_aegis_config.json"
    ...
    def guardar_configuracion(self, nombre_archivo: str = "ares_aegis_config.json") -> bool:
        """
