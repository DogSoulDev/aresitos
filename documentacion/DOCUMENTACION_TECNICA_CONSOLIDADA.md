...
### Protección avanzada anti-logout/crash y validación de comandos
...
En el módulo `utils/detener_procesos.py`, la función `_terminar_procesos_por_nombre` filtra y protege explícitamente procesos de sesión, terminales, shells y servicios críticos. Ejemplo real:
