...
def verificar_gestor_permisos():
    ...
    try:
        ...
        logger.info("✅ Gestor de permisos importado correctamente")
        
        # Crear instancia
        gestor = GestorPermisosSeguro(logger)
        
        # Generar reporte completo
        logger.info("📊 Generando reporte de permisos...")
        reporte = gestor.generar_reporte_permisos()
        
        # Mostrar reporte
        print("\n" + "="*60)
        print("🛡️  REPORTE DE PERMISOS ARES AEGIS")
        print("="*60)
        
        print(f"\n👤 Usuario actual: {reporte['usuario']}")
        ...
        for herramienta, info in reporte['herramientas'].items():
            status_icon = "✅" if info['disponible'] and info['permisos_ok'] else "❌"
        ...
        if 'nmap' in reporte['herramientas'] and reporte['herramientas']['nmap']['disponible']:
            ...
            if exito:
                print("✅ nmap ejecutado correctamente")
